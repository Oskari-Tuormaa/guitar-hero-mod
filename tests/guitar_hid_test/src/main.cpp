...
namespace globals
{
    ...
    static inputReport_t report {
        .BTN_GamePadButton1 = 1,
    };
...
void send_report(inputReport_t report)
{
    std::array<uint8_t, 1 + sizeof(report)> message { 0xa1 };
    std::memcpy(&message[1], &report, sizeof(report));
...
void dummy_report_handler(btstack_timer_source_t* ts)
{
    ...
    {
        globals::report.GD_GamePadRz += 200;
        uint8_t tmp                        = globals::report.BTN_GamePadButton1;
        globals::report.BTN_GamePadButton1 = globals::report.BTN_GamePadButton2;
        globals::report.BTN_GamePadButton2 = globals::report.BTN_GamePadButton3;
        globals::report.BTN_GamePadButton3 = globals::report.BTN_GamePadButton4;
        globals::report.BTN_GamePadButton4 = tmp;
...
void setup_hid()
{
    ...
    hid_sdp_record_t hid_params {
        ...
        .hid_descriptor           = report_descriptor.begin(),
        .hid_descriptor_size      = report_descriptor.size(),
    ...
    hid_device_init(config::hid::boot_device, report_descriptor.size(),
                    report_descriptor.begin());
